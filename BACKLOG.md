...
**Last updated:** 2026-06-11 — Branch 50 (`feat/ui-redesign`) — PR #105, #106 (full redesign + app-wide light mode, shared geometric icon set, tray + dialog consistency, keyboard nav, old-design cleanup).
